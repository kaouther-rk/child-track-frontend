...
export function JoinPictureLayout({ src }: { src: string }) {
    return (
...
export function JoinCard({ children }: { children: React.ReactNode }) {
    return (
...
export function JoinTitle({ title }: { title: string }) {
    return (
